...
//=============================================================
void drawMesh::drawTriangleCoorArr(double *triangleCoorArr, int triangArrSize,  int color){
	int triangCell[8];
...
//=============================================================
void drawMesh::drawLine(point p1, point p2, int color){
	setcolor(color);
	line(p1.getX()*scale + originalX, p1.getY()*scale + originalY, p2.getX()*scale + originalX, p2.getY()*scale + originalY);
}

//=============================================================
void drawMesh::drawLineArr(point *pointArr, int pointNum,  int color){
	for(unsigned i=0; i<pointNum-1; i++){
		drawLine(pointArr[i], pointArr[i+1], color);
	}
}
