...
//	unsigned long int *pointIdArr;
	...
	coarsePartition(unsigned int color, unsigned int partId, unsigned int activePartNum, unsigned long long initTriangleSize, unsigned int xPartNum, unsigned int yPartNum, std::string srcPath, std::string dstPath);
	~coarsePartition();
