...
public:
	...
	coarsePartition(unsigned int color, unsigned int partId, unsigned int activePartNum, unsigned long long initTriangleSize, unsigned int xPartNum, unsigned int yPartNum, double *infoArr, unsigned *pointNumArr, double *initPointCoorArr, unsigned long long *initPointIdArr, unsigned initPointNum, double *activeTriangleCoorArr_submaster, unsigned long long *activeTriangleIdArr_submaster, unsigned triangleNum);
	~coarsePartition();
