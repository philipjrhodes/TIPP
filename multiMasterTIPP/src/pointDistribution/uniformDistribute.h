...
//	double *basicInitDomainPointCoorArr;
//	double *basicInitPartPointCoorArr;
...
//	unsigned int pointGridArrSize;
	...
	distribute(unsigned int xCoarsePartNumber, unsigned int yCoarsePartNumber, unsigned int xFinePartNumber, unsigned int yFinePartNumber, unsigned long long totalNumberPoints, unsigned int initialCoarsePointNum, unsigned int initialFinePointNum, std::string fullPath);
	~distribute();
};
