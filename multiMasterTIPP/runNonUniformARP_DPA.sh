...
if [ -z "$(ls -A $7/$9/)" ]; then
	if [ $6 -eq 0 ]; then
		...
		echo "./bin/nonUniformDistributeAdaptive $1 $1 $2 $3 $7/$9/ 10 15"
		./bin/nonUniformDistributeAdaptive $1 $1 $2 $3 $7/$9/ 10 15
		#/home/cc/freeCluster
	fi
...
if [ -z "$(ls -A $7/$9/)" ]; then
	...
	echo "mpiexec -n $5 -f machinefile ./bin/TIPP $7/$9/ $8/$9/ $1 $4"
	mpiexec -n $5 -f machinefile ./bin/TIPP $7/$9/ $8/$9/ $1 $4
fi
...
echo "./bin/drawDomain $7/$9/ $8/$9/ $1"
#./bin/drawDomain $7/$9/ $8/$9/ $1
