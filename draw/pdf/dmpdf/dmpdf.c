...
int init_page(char *fname){
    ...
    HPDF_Page_SetLineWidth (page, 0.01);
    
    int ox=0, oy=0;  // origin
    int width=HPDF_Page_GetWidth(page), height=HPDF_Page_GetHeight (page);  // upper right corner
    int margin=5;
    
    
//     HPDF_Page_Rectangle (page, 50, 50, HPDF_Page_GetWidth(page) - 100,
//                 HPDF_Page_GetHeight (page) - 110);
    HPDF_Page_Rectangle (page, ox+margin, oy+margin, width-2*margin, height-2*margin);
