...
/*
	setcolor(RED);
	line(0.25 * scale + originalX, 0.25*scale + originalY, 0.25*scale + originalX, 0.5*scale + originalY);
	line(0.5 * scale + originalX, 0.25*scale + originalY, 0.5*scale + originalX, 0.5*scale + originalY);
	line(0.25 * scale + originalX, 0.25*scale + originalY, 0.5*scale + originalX, 0.25*scale + originalY);
