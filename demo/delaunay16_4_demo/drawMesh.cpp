...
drawMesh::drawMesh(){
	...
	scale = 350;	originalX = 20;	originalY = 20;
	scale = 1000; originalX = -450; originalY = -450;

//	scale = 1000; originalX = -400; originalY = 0;

//	scale = 1300; originalX = -580; originalY = -580;
...
void drawMesh::drawTriangleArr(triangle *triangleArr, int triangArrSize,  int color){
	...
	//if((p1.getX()>0.375)&&(p1.getY()>0.375)){
...
void drawMesh::drawCoordinateTriangles(double *triangleCoorArr, int triangleCoorArrSize,  int color){
	...
	//if((triangleCoorArr[i*6]>0.375)&&(triangleCoorArr[i*6+1]>0.375)){
