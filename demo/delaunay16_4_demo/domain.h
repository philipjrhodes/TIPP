...
//	domain(const point &lPoint, const point &hPoint, std::string pathStr);
	...
	void readTriangleIdArr(unsigned long long *&triangleIdArr, unsigned long long &triangleNum, std::string fileStr);
	void readTriangleCoorArr(double *&triangleCoorArr, unsigned long long &triangleNum, std::string fileStr);
