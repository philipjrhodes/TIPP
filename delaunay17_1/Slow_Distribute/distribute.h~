...
public:
	...
	void writeListToFile(std::list<point> pointList, unsigned int partCoarseId, unsigned int partFineId);
	void writeToBinaryFile(std::string fileStr, unsigned int partCoarseId, unsigned int partFineId, point *data, unsigned int size);
	...
	distribute(double domainsize, unsigned int xCoarsePartNumber, unsigned int yCoarsePartNumber, unsigned int xFinePartNumber, unsigned int yFinePartNumber, std::string sourcePath, std::string verInfoFile, std::string verFile, std::string resultPath, unsigned long long chunksize, unsigned int initcoarsesize, unsigned int initfinesize);
	~distribute();
};
