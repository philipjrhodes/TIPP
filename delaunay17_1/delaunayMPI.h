...
//	unsigned long long *pointNumPartOffsetArr;
	...
	double processStoreTriangles(unsigned int my_rank, unsigned int finePartId, unsigned int pool_size, MPI_Comm row_comm, unsigned int coarsePartId, unsigned int xCoarsePartNum, unsigned int yCoarsePartNum);
	void storeTriangleCoors(double *triangleCoorArr, unsigned int triangleCoorArrSize, std::string fileStr);
	double processTriangleList(unsigned int my_rank, unsigned int pool_size, MPI_Comm row_comm, unsigned int coarsePartId, unsigned int xCoarsePartNum, unsigned int yCoarsePartNum);
	void printTriangleList(unsigned int finePartId);
	double processMPI(unsigned int my_rank, unsigned int pool_size, MPI_Comm row_comm, unsigned int coarsePartId, unsigned int xCoarsePartNum, unsigned int yCoarsePartNum);
