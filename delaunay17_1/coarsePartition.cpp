...
//===================================================================
coarsePartition::coarsePartition(unsigned int color, unsigned int partId, unsigned int activePartNum, unsigned int initTriangleSize, unsigned int xPartNum, unsigned int yPartNum, unsigned int numberOfNodes, std::string dataNameStr){
...
void coarsePartition::readPointPartInfo(){
	...
	std::string fileInfoStr = generateFileName(coarsePartId, folderShare + dataName + "/pointPartInfo", xCoarsePartNum*yCoarsePartNum, ".xfdl");
...
void coarsePartition::loadInitPoints(){
	std::string	folderShare = "/data" + toString(coarsePartId % nodeNum) + "/";
	std::string fileStr = generateFileName(coarsePartId, folderShare + dataName + "/initPointPart", xCoarsePartNum*yCoarsePartNum, ".ver");
...
void coarsePartition::loadInitTriangles(){
	std::string	folderShare = "/data" + toString(groupId % nodeNum) + "/";
	std::string fileStr = generateFileName(groupId, folderShare + dataName + "/tempCoorCoarseParts", activeCoarsePartNum, ".tri");
	...
	fileStr = generateFileName(groupId, folderShare + dataName + "/tempPointIdCoarseParts", activeCoarsePartNum, ".tri");
...
//std::cout<<"&&&&&&&&&&&&&triangleIdList is empty\n";
	...
	std::string	folderShare = "/data" + toString(coarsePartId % nodeNum) + "/";
	std::string fileStr = generateFileName(coarsePartId, folderShare + dataName + "/triangleIds", xCoarsePartNum*yCoarsePartNum, ".tri");
	...
	fileStr = generateFileName(coarsePartId, folderShare + dataName + "/boundaryTriangles", xCoarsePartNum*yCoarsePartNum, ".tri");
...
//		std::cout<<"\n\n";
	...
	std::string fileStr = generateFileName(coarsePartId, folderShare + dataName + "/tempCoorFineParts", xCoarsePartNum*yCoarsePartNum, ".tri");
	...
	std::string fileStr2 = generateFileName(coarsePartId, folderShare + dataName + "/tempPointIdFineParts", xCoarsePartNum*yCoarsePartNum, ".tri");
...
void coarsePartition::addReturnTriangles(){
	std::string	folderShare = "/data" + toString(coarsePartId % nodeNum) + "/";
//	std::string returnStoreName = generateFileName(coarsePartId, folderShare + dataName + "/returnStoreTriangleIds", xCoarsePartNum*yCoarsePartNum, ".tri");
//	std::string returnAllStoreName = generateFileName(coarsePartId, folderShare + dataName + "/returnAllStoreTriangleIds", xCoarsePartNum*yCoarsePartNum, ".tri");
...
//	addFile(returnStoreName, returnAllStoreName);
	...
	std::string returnTriangleIdsName = generateFileName(coarsePartId, folderShare + dataName + "/returnTriangleIds", xCoarsePartNum*yCoarsePartNum, ".tri");
	std::string returnAllTriangleIdsName = generateFileName(coarsePartId, folderShare + dataName + "/returnAllTriangleIds", xCoarsePartNum*yCoarsePartNum, ".tri");
	...
	std::string returnTriangleCoorsName = generateFileName(coarsePartId, folderShare + dataName + "/returnTriangleCoors", xCoarsePartNum*yCoarsePartNum, ".tri");
	std::string returnAllTriangleCoorsName = generateFileName(coarsePartId, folderShare + dataName + "/returnAllTriangleCoors", xCoarsePartNum*yCoarsePartNum, ".tri");
...
//std::cout<<"undelivered triangles: "<<count<<"\n";
	...
	std::string fileStr = generateFileName(coarsePartId, folderShare + dataName + "/returnAllTriangleCoors", xCoarsePartNum*yCoarsePartNum, ".tri");
	double *tempCoorArr;
	unsigned int triangleNum;
	...
	fileStr = generateFileName(coarsePartId, folderShare + dataName + "/returnAllTriangleIds", xCoarsePartNum*yCoarsePartNum, ".tri");
	unsigned long long *tempPointIdArr;
...
void coarsePartition::storeAllTriangles(){
	...
	std::string	folderShare = "/data" + toString(coarsePartId % nodeNum) + "/";
	//store tempPointIdArr to triangleIdsXX.tri
	std::string fileStr = generateFileName(coarsePartId, folderShare + dataName + "/triangleIds", xCoarsePartNum*yCoarsePartNum, ".tri");
	FILE *f = fopen(fileStr.c_str(), "a");
	if(!f){
		std::cout<<"not exist "<<fileStr<<std::endl;
