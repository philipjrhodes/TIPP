...
void drawMesh::drawTriangles(triangleNode *triangleList, int color){
	...
	while(scanNode!=NULL){
		...
		float centerX = scanNode->tri->centerX;
		float centerY = scanNode->tri->centerY;
		float radius = scanNode->tri->radius;
...
void drawMesh::drawTriangleArr(triangle *triangleArr, int triangArrSize,  int color){
	...
	for(int i=0; i<triangArrSize; i++){
		...
		float centerX = triangleArr[i].centerX;
		float centerY = triangleArr[i].centerY;
		float radius = triangleArr[i].radius;
