...
//	domain(const point &lPoint, const point &hPoint, std::string pathStr);
	...
	//draw boundary triangles that intersect with current partition
	void drawBoundaryTriangleArr(int partId);

	void drawTriangleArr();
	void drawTriangleArr1();
	void drawLeftOverTriangleArr();
	void drawReturnAndStoreTriangles();
	...
	void runDelaunayMPI(int domainSize, int activePartNum);
