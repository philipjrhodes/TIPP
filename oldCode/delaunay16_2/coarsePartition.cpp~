...
void coarsePartition::deliverTriangles(unsigned long long *&returnStoreTriangleIdArr, unsigned int &returnStoreTriangleIdArrSize){
...
void coarsePartition::storeAllTriangles(unsigned long long *&returnStoreTriangleIdArr, unsigned int &returnStoreTriangleIdArrSize){
