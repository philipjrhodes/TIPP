...
//	unsigned long int *pointIdArr;
	...
	coarsePartition(unsigned int color, unsigned int partId, unsigned int activePartNum, unsigned int initTriangleSize, unsigned int xPartNum, unsigned int yPartNum, unsigned int numberOfNodes, std::string dataNameStr);
	~coarsePartition();
