...
#mpic++ -std=gnu++11 -O3 delaunayMPI.cpp linkList.cpp common.cpp point.cpp edge.cpp triangle.cpp gridElement.cpp gridBound.cpp boundingBox.cpp partition.cpp domain.cpp -o delaunayMPI
...
mpiexec -n 8 -f machinefile ./delaunay2DMain "../dataSources/100vertices/" 1
...
#mpiexec -n 4 -f machinefile ./delaunay2DMain "../dataSources/10Kvertices/" 1
