...
//	void pointsDistribute1();
	...
	void writeListToFile(std::list<double> pointList, int partitionId);
	void writeToBinaryFile(std::string fileStr, int partitionId, double *data, unsigned int size);
