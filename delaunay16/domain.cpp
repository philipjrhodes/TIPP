...
/*
	//add all triangle Ids in returnAllStoreTriangleIds.tri to triangleIds.tri
	for(unsigned int index=0; index<activePartArrSize; index++){
		std::string storedFileStr = generateFileName(activePartArr[index], "returnAllStoreTriangleIds", xPartNum*yPartNum, ".tri");
