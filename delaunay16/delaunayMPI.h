...
//	unsigned long long *pointIdArr;
	...
	void triangulate(unsigned int finePartId, unsigned int my_rank);
	...
	void processStoreTriangles(unsigned int my_rank, unsigned int pool_size, MPI_Comm row_comm, unsigned int coarsePartId, unsigned int xCoarsePartNum, unsigned int yCoarsePartNum);
