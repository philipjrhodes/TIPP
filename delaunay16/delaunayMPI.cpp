...
//			std::cout<<triangleNumOffsetArr[i]<<"\n";
	...
	//save to single file
	std::string currPath = generateFileName(coarsePartId, path + "delaunayResults/returnTriangleIds", xCoarsePartNum*yCoarsePartNum, ".tri");
//	std::string currPath = path+ "delaunayResults/returnTriangleIds.tri";
	...
	std::string currPath1 = generateFileName(coarsePartId, path + "delaunayResults/returnTriangleCoors", xCoarsePartNum*yCoarsePartNum, ".tri");
