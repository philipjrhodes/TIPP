...
public:
	...
	void convertVertexFile(string vertexTextFileName, int attributeRecordSize, int *recordSize, unsigned int *recordCount);

	void readBinaryFile(string binaryFileName, int bufferSize);

	void printDoubleFile(string fileNameStr, int recordSize, unsigned int recordCount);
