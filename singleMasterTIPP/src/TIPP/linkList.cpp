...
triangleNode *extractNode(triangleNode *&head, triangleNode *preP, triangleNode *&currP){
	...
	else{ //extract middle or last node
		temp = currP;
		preP->next = currP->next;
		currP = preP->next;
	}
...
//============================================================================
void listToTriangleIdCoorArr(triangleNode *triangleList, unsigned long long *triangleIdArr, double *triangleCoorArr, unsigned triangleNum){
	if(triangleList==NULL){
		triangleIdArr = NULL;
		triangleNum = 0;
		return;
